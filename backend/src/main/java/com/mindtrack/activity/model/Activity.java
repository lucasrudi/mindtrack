package com.mindtrack.activity.model;
...
/**
 * JPA entity representing a trackable activity.
 */
@Entity
...
public class Activity {
    ...
    @Column(name = "linked_interview_id")
    ...
    private Set<Goal> linkedGoals = new HashSet<>();
    ...
    public Set<Goal> getLinkedGoals() {
        return linkedGoals;
    }

    public void setLinkedGoals(Set<Goal> linkedGoals) {
